...
/* However, global free lists are known to the collector.  "Tiny" free  */
/* lists are basically private to the client.  Their contents are       */
/* viewed as "in use" and marked accordingly by the core of the         */
/* collector.  Note that inlined code might know about the layout of    */
/* these and the constants involved.  Thus any change here may          */
/* invalidate clients, and such changes should be avoided.  Hence we    */
...
/* affects the binary interface (ABI) to the library.                   */
