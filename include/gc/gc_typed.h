...
/* Return a type descriptor for the object whose layout is      */
/* described by the argument.  The least significant bit of the */
/* first word is one if the first word in the object may be     */
/* a pointer.  The second argument specifies the number of      */
/* meaningful bits in the bitmap.  The actual object may be     */
/* larger (but not smaller).  Any additional words in the       */
/* object are assumed not to contain pointers.  Returns a       */
/* conservative approximation in the (unlikely) case of         */
/* insufficient memory to build the descriptor.  Calls to       */
...
/* It is possible to generate a descriptor for a client type T  */
/* with word-aligned pointer fields f1, f2, ... as follows:     */
/*                                                              */
/* GC_descr T_descr;                                            */
